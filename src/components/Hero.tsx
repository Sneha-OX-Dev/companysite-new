...
export default function Hero() {
  return (
    <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-10 pt-10 pb-20 text-center">
      <div
        ...
        <div className="flex-1 space-y-7">
          ...
          <div className="flex-col items-center gap-3">
            <Image
              ...
              width={20}
              height={20}
              className="hidden h-16 w-16 text-white sm:inline-block"
            />
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/40 px-4 py-1.5 text-[9px] font-semibold uppercase tracking-[0.22em] text-zinc-200 backdrop-blur ">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-[9px] leading-relaxed text-white/70">
          ...
          <div className="space-y-1">
            ...
            <p className="bg-linear-to-r from-white via-zinc-200 to-[var(--accent)] bg-clip-text text-xl font-semibold tracking-[-0.04em] text-transparent sm:text-3xl md:text-[28px]">
      ...
      {/* three pillars */}
      <div className="mt-8 grid w-full max-w-2xl grid-cols-1 gap-4 self-start px-6 sm:grid-cols-3 md:gap-5 md:px-0">
        {[
          ...
          <div
            key={text}
            className="group flex text-start gap-3 rounded-xl border border-white/10 bg-black/40 px-4 py-4 text-[9px] text-white/75 shadow-[0_16px_60px_rgba(0,0,0,0.6)] transition hover:border-[var(--accent)]/70 hover:bg-black/60"
          >
      ...
      {/* CTAs */}
      <div className="mt-8 flex w-full max-w-6xl items-center justify-start gap-3 px-6 md:px-0">
        <Link
          href="#machine-self"
