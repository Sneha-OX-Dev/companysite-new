...
const navItems = [
  ...
  { label: "The Problem & Fix", href: "#problem-fix" },
  { label: "What Is OX", href: "#what-is-ox" },
...
export default function HomeNavbar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-indigo-900/50 bg-linear-to-b from-[#0f1424]/95 via-[#0f1424]/90 to-transparent backdrop-blur">
